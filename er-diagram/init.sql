...
START TRANSACTION;
USE `jmrs`;
INSERT INTO `jmrs`.`book` (`book_id`, `book_user_id`, `room_id`, `book_date`, `start_time`, `end_time`, `name`, `comment`) VALUES (1, 2, 1, '2016-11-26', '09:30:00', '11:30:00', 'test book', 'just test');
